...
#     return policy_store
#
# def save_replays(policy_store_dir, save_dir, curriculum_file, task_to_assign=None): # def save_replays(policy_store_dir, save_dir):
...
#     # CHECK ME: can be custom models with different architectures loaded here?
#     policy_store = setup_policy_store(policy_store_dir)  # TODO 这里看一下，怎样得出的评价分数
#     policy_ranker = create_policy_ranker(policy_store_dir)
#     num_policies = len(policy_store._all_policies())
