...
class OpenELMTaskGenerator(LearnableTaskSampler):
    ...
    def evolve_tasks(
        ...
        and return the num_tasks task specs 为给定的步骤数演化给定的任务规范，并返回num_tasks任务规范
        """
        ...
        while best_task is None:
            ...
            # TODO: we may want to sample best ones across the MAP (see MAP-Elites) 我们可能想在MAP中取样最好的（请参阅MAP精英）
